import { Shield, UserCheck, Users, Key } from 'lucide-react';

export function RoleStatsCards({ stats = {}, loading = false }) {
  const cards = [
    {
      title: 'Total Roles',
    ...
    },
    {
      ...
      value: stats.totalUsersAssigned ?? 0,
    ...
    },
    {
      ...
      value: stats.totalPermissions ?? 45,
