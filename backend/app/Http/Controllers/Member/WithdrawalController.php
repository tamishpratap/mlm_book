    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'member' => [
                ...
                'wallet_address' => $member->wallet_address ?? $member->reward_wallet_address ?? '',
                'ad_balance' => (float) ($member->ad_balance ?? 0.00),
                'reward_balance' => (float) ($member->reward_balance ?? 0.0000),
                'reward_wallet_address' => $member->reward_wallet_address ?? '',
