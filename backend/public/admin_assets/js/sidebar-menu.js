(function ($) {
  ...
  if ($("#pageWrapper").hasClass("compact-wrapper")) {
    jQuery(".sidebar-title").append('<div class="according-menu"><i data-feather="chevron-right"></i></div>');
    jQuery(".sidebar-title").click(function (e) {
      if (jQuery(this).next().is("ul.sidebar-submenu")) {
        e.preventDefault();
      }
      jQuery(".sidebar-title").removeClass("active").find("div").replaceWith('<div class="according-menu"><i data-feather="chevron-right"></i></div>');
    ...
    jQuery(".submenu-title").click(function (e) {
      e.preventDefault();
      jQuery(".submenu-title").removeClass("active").find("div").replaceWith('<div class="according-menu"><i data-feather="chevron-right"></i></div>');
    ...
    const horizontalMenu = () => {
      ...
      if (contentwidth <= 992 && !smallSize) {
        ...
        jQuery(".sidebar-title").click(function (e) {
          ...
          jQuery(".sidebar-title").find("div").replaceWith('<div class="according-menu"><i data-feather="chevron-right"></i></div>');
          jQuery(".sidebar-submenu, .menu-content").slideUp("normal");
          if (jQuery(this).next().is(":hidden") == true) {
            jQuery(this).addClass("active");
            jQuery(this).find("div").replaceWith('<div class="according-menu"><i data-feather="chevron-down"></i></div>');
  ...
  // ensure feather icons render for dynamically added menu icons
