<div
    class="story-modal comment-reactors-modal"
    role="dialog"
    aria-modal="true"
    aria-labelledby="comment-reactors-title"
    data-comment-reactors-modal
>
    <button class="story-modal__backdrop" type="button" aria-label="Close Comment Reactions" data-comment-reactors-close></button>

    <div class="story-modal__panel comment-reactors-modal__panel">
        <header class="story-modal__header">
            <div>
                <span>Comment Reactions</span>
                <h2 id="comment-reactors-title">All Reactions ({{ $reactions->count() }})</h2>
            </div>
            <button class="story-modal__close" type="button" aria-label="Close Comment Reactions" data-comment-reactors-close>
                <i data-lucide="x" aria-hidden="true"></i>
            </button>
        </header>

        <div class="comment-reactors-modal__body">
