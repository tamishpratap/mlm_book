...
Route::prefix('member')->name('api.member.')->group(function () {
    ...
    Route::middleware(['auth:member', UpdateLastSeenMiddleware::class])->group(function () {
        ...
        Route::prefix('business-pages')->group(function () {
            ...
            Route::get('/{businessPage:slug}/ad-campaigns/{adCampaign}/analytics', [BusinessAdCampaignController::class, 'campaignAnalytics']);
            Route::get('/{businessPage:slug}/ad-campaigns/{adCampaign}/engagements', [BusinessAdCampaignController::class, 'engagements']);
            Route::get('/{businessPage:slug}/ad-campaigns/{adCampaign}/export-engagements', [BusinessAdCampaignController::class, 'exportEngagements']);
            Route::post('/{businessPage:slug}/ad-campaigns/{adCampaign}/contact-audience', [BusinessAdCampaignController::class, 'contactAudience']);
            Route::get('/{businessPage:slug}/ad-campaigns/{adCampaign}/engagements/{member}', [BusinessAdCampaignController::class, 'memberEngagementDetail']);
            Route::get('/{businessPage:slug}/ad-campaigns/{adCampaign}', [BusinessAdCampaignController::class, 'show']);
            Route::put('/{businessPage:slug}/ad-campaigns/{adCampaign}', [BusinessAdCampaignController::class, 'update']);
            Route::post('/{businessPage:slug}/ad-campaigns/{adCampaign}/submit', [BusinessAdCampaignController::class, 'submit']);
            Route::post('/{businessPage:slug}/ad-campaigns/{adCampaign}/pause', [BusinessAdCampaignController::class, 'pause']);
            Route::post('/{businessPage:slug}/ad-campaigns/{adCampaign}/resume', [BusinessAdCampaignController::class, 'resume']);
            Route::post('/{businessPage:slug}/ad-campaigns/{adCampaign}/stop', [BusinessAdCampaignController::class, 'stop']);
            Route::post('/{businessPage:slug}/ad-campaigns/{adCampaign}/add-funds', [BusinessAdCampaignController::class, 'addFunds']);
            Route::post('/{businessPage:slug}/ad-campaigns/{adCampaign}/top-up', [BusinessAdCampaignController::class, 'addFunds']);
