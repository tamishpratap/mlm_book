...
const WORKFLOW_STEPS = [
  ...
  },
  {
    ...
    subtitle: 'Advertising & Events',
    icon: Megaphone,
    color: 'blue',
    description: 'Create supported advertising or Event campaigns to promote your content.',
  ...
  },
  {
    ...
    icon: Wallet,
    color: 'amber',
    description: 'Successfully issued rewards are credited to the member’s Reward Wallet.',
